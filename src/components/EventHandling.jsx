  ...
  return (
    <div className='container'>
        ...
        <input type="text" className='form-control
         mt-4' onChange={(e)=>{console.log (e.target.value)}} />  {/* koi bhi value nikaaal skte h iske through i.e jo bhi user enter kr raha and onnchange mtlb jab koi value change krenge srf click krne pe nhi ho rhi change, hm enter kr rhe*/}
